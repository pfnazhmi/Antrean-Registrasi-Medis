...
class AntreanMedisGUI:
    ...
    def create_widgets(self):
        ...
        self.button_poli = tk.Button(self.master, text="Lihat Poli", command=self.daftar_poli)
    ...
    def daftar_poli(self):
        try:
            klinik_list = self.server.daftar_poli()
    ...
    def lihat_antrian(self):
        klinik = simpledialog.askstring("Masukkan Nama Poli", "Masukkan nama poli:")
        if klinik:
            try:
    ...
    def mendaftar(self):
        ...
        if klinik and nomor_rekam_medis and nama and tanggal_lahir:
            try:
